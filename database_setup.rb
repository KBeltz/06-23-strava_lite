...
DATABASE.execute("CREATE TABLE IF NOT EXISTS rides (id INTEGER PRIMARY KEY, cyclist_id INTEGER NOT NULL, bike_id INTEGER NOT NULL, ride_name TEXT, miles DECIMAL (5,2) NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP);")
