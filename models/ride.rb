...
class Ride
  ...
  attr_accessor :id, :cyclist_id, :bike_id, :ride_name, :miles, :datetime
  ...
  # datetime   - date time value generated by the database
  #
  # Returns a Bike object
  
  def initialize(options = {})
    
    # Example: {"id" => 1, "cyclist_id" => "3", "bike_id" => "2", "ride_name" => "Keystone trail", "miles" => "10.7", "datetime" => }
    @id = options["id"]
